...
public class JsonUtility {
    ...
    public static JsonNode convertToJson(List<Map<String, Object>> data, JsonNode jsonSchema) throws IOException {
        ...
        for (Map<String, Object> map : data) {
            ObjectNode node = objectMapper.convertValue(map, ObjectNode.class);
            ...
            if (!propertyType.equals(dataNodeType)) {
                switch (propertyType) {
                    ...
                    case "boolean":
                        ...
                        break;
                    case "array":
                        transformBySchema(inputNode,jsonSchema);
                        break;
                    case "object":
    ...
    private static JsonNode transformObject(ObjectNode inputNode, JsonNode jsonSchema){
